...
public class MiniCubeControl : MonoBehaviour
{
    ...
    public GameObject cubeDisplay2;
    public GameObject solver;
    NeuralNetwork nn;
    NeuralNetwork nn0, nn1, nn2, nn3;
    ...
    void Start()
    {
        ...
        mini2 = new MiniCube();
        cubeDisplay2.GetComponent<MiniCubeDisplay>().SetCube(mini);
        cubeDisplay2.GetComponent<MiniCubeDisplay>().ShowCube();
        for (x = 0; x < 270; x++)
        {
            cubeDisplay2.GetComponent<MiniCubeDisplay>().RotateCube(2);
        }
        for (x = 0; x < 90; x++)
        {
            cubeDisplay2.GetComponent<MiniCubeDisplay>().RotateCube(3);
        }
    ...
    void Update()
    {
        ...
        if (solving)
        {
            ...
            if (cubeCounter <= 0)
            {
                ...
                cubeDisplay2.GetComponent<MiniCubeDisplay>().UpdateCube();
        ...
        **/
        ...
        if (Input.GetKey("s"))
        {
            ...
            cubeDisplay2.GetComponent<MiniCubeDisplay>().RotateCube(1);
        }
        if (Input.GetKey("a"))
        {
        ...
        if (Input.GetKey("d"))
        {
            ...
            cubeDisplay2.GetComponent<MiniCubeDisplay>().RotateCube(4);
        }
        if (Input.GetKey("q"))
        {
            cubeDisplay.GetComponent<MiniCubeDisplay>().RotateCube(6);
            cubeDisplay2.GetComponent<MiniCubeDisplay>().RotateCube(6);
        }
        if (Input.GetKey("e"))
        {
            cubeDisplay.GetComponent<MiniCubeDisplay>().RotateCube(5);
            cubeDisplay2.GetComponent<MiniCubeDisplay>().RotateCube(5);
        }
    }
    ...
    public void TrainNN5_0(NeuralNetwork network)
    {
        float[] inputs = new float[154];
        float[] outputs = new float[6];
        int x, y, z;
    ...
    public void MakeGoodNN5_0()
    {
        ...
        for (x = 0; x < 12; x++)
        {
            ...
            //to layer 1
            //node 0 
            nn5_0.AddConnection(0, p0, 1, x * 2, -0.383487f);
            nn5_0.AddConnection(0, p0, 1, x * 2 + 1, 4.895471f);
            //node 2
            nn5_0.AddConnection(0, 152, 1, x * 2, -0.3173361f);
            nn5_0.AddConnection(0, 152, 1, x * 2 + 1, 4.944991f);
            //node 3
            nn5_0.AddConnection(0, 154, 1, x * 2, 0.9871098f);
            nn5_0.AddConnection(0, 154, 1, x * 2 + 1, -7.647758f);

            //to layer 2
            //node 1
            nn5_0.AddConnection(0, p1, 2, x * 2, -5.810718f);
            nn5_0.AddConnection(0, p1, 2, x * 2 + 1, -0.2540283f);


            nn5_0.AddConnection(1, x * 2, 2, x * 2, -2.227202f);
            nn5_0.AddConnection(1, x * 2, 2, x * 2 + 1, -1.523751f);
            nn5_0.AddConnection(1, x * 2 + 1, 2, x * 2, 8.22331f);
            nn5_0.AddConnection(1, x * 2 + 1, 2, x * 2 + 1, 6.760274f);
            nn5_0.AddConnection(1, 24, 2, x * 2, -4.273445f);
            nn5_0.AddConnection(1, 24, 2, x * 2 + 1, -3.444222f);

            //to layer 3 output white
            nn5_0.AddConnection(2, x * 2, 3, choice, -6.172615f);
            nn5_0.AddConnection(2, x * 2 + 1, 3, choice, 6.331503f);
            nn5_0.AddConnection(2, 24, 3, choice, -0.4769176f);
        }


        //biases only blue prime
        nn5_0.AddConnection(2, 24, 3, 3, -0.4054653f);
    }
    public void MakeGoodNN5_0Random()
    {
        nn5_0 = new NeuralNetwork();
        nn5_0.AddCollumn(0);
        nn5_0.AddCollumn(1);
        ...
        for (x = 0; x < 12; x++)
        {
            ...
            //to layer 1
            //node 0 
            nn5_0.AddConnection(0, p0, 1, x * 2, Random.Range(-1f, 1f));
            nn5_0.AddConnection(0, p0, 1, x * 2 + 1, Random.Range(-1f, 1f));
            //node 2
            nn5_0.AddConnection(0, 152, 1, x * 2, Random.Range(-1f, 1f));
            nn5_0.AddConnection(0, 152, 1, x * 2 + 1, Random.Range(-1f, 1f));
            //node 3
            nn5_0.AddConnection(0, 154, 1, x * 2, Random.Range(-1f, 1f));
            nn5_0.AddConnection(0, 154, 1, x * 2 + 1, Random.Range(-1f, 1f));

            //to layer 2
            //node 1
            nn5_0.AddConnection(0, p1, 2, x * 2, Random.Range(-1f, 1f));
            nn5_0.AddConnection(0, p1, 2, x * 2 + 1, Random.Range(-1f, 1f));


            nn5_0.AddConnection(1, x * 2, 2, x * 2, Random.Range(-1f, 1f));
            nn5_0.AddConnection(1, x * 2, 2, x * 2 + 1, Random.Range(-1f, 1f));
            nn5_0.AddConnection(1, x * 2 + 1, 2, x * 2, Random.Range(-1f, 1f));
            nn5_0.AddConnection(1, x * 2 + 1, 2, x * 2 + 1, Random.Range(-1f, 1f));
            nn5_0.AddConnection(1, 24, 2, x * 2, Random.Range(-1f, 1f));
            nn5_0.AddConnection(1, 24, 2, x * 2 + 1, Random.Range(-1f, 1f));

            //to layer 3 output white
            nn5_0.AddConnection(2, x * 2, 3, choice, Random.Range(-1f, 1f));
            nn5_0.AddConnection(2, x * 2 + 1, 3, choice, Random.Range(-1f, 1f));
            nn5_0.AddConnection(2, 24, 3, choice, Random.Range(-1f, 1f));
        }


        //biases only blue prime
        nn5_0.AddConnection(2, 24, 3, 3, Random.Range(-1f, 1f));
    }
    ...
    public void makeGoodNN5_1()
    {
        ...
        nn5_0.DeleteNeuron(1, 12);
        nn5_0.ConnectNeuronToCollumn(0, 154, 1);//biases
        nn5_0.ConnectNeuronToCollumn(0, 152, 1);//biases
        for (x = 0; x < 21; x++)
        {
            if (x == 0 || x == 5 || x == 7)
                nn5_0.ConnectNeuronToCollumn(0, x, 1);
            if (x == 3 || x == 8 || x == 14 || x == 19 || x == 10 || x == 17)
                nn5_0.ConnectNeuronToCollumn(0, 21 + x, 1);
            if (x == 0 || x == 11 || x == 16 || x == 20)
                nn5_0.ConnectNeuronToCollumn(0, 42 + x, 1);
        }
        nn5_0.AddNeuron(1, 12);
        nn5_0.ConnectCollumnToCollumn(1, 2);
    ...
    public void addDummy()
    {
        ...
        string str = dummyColl.text;
        int choice;
        bool worked = int.TryParse(str, out choice);
        if (worked)
            nn1.AddCollumn(choice);
    ...
    {
        display.GetComponent<NeuralNetworkDisplay>().DeleteNNDisplay();
        string str1 = neuronColl.text;
        string str2 = neuronRow.text;
        int choice1, choice2;
        bool worked1 = int.TryParse(str1, out choice1);
        bool worked2 = int.TryParse(str2, out choice2);
        if (worked1 && worked2)
            nn1.AddNeuron(choice1, choice2);
        display.GetComponent<NeuralNetworkDisplay>().CreateNNDisplay();
        display.GetComponent<NeuralNetworkDisplay>().NNactivated();
    }
    public void deleteNeuron()
    {
        ...
        bool worked2 = int.TryParse(str2, out choice2);
        if (worked1 && worked2)
            nn1.DeleteNeuron(choice1, choice2);
        display.GetComponent<NeuralNetworkDisplay>().CreateNNDisplay();
        display.GetComponent<NeuralNetworkDisplay>().NNactivated();
    }
    ...
    {
        display.GetComponent<NeuralNetworkDisplay>().DeleteNNDisplay();
        string str1 = connectionColl1.text;
        string str2 = connectionRow1.text;
        string str3 = connectionColl2.text;
        string str4 = connectionRow2.text;
        string str5 = connectionValue.text;
        int choice1, choice2, choice3, choice4;
        float choice5;
        bool worked1 = int.TryParse(str1, out choice1);
        bool worked2 = int.TryParse(str2, out choice2);
        bool worked3 = int.TryParse(str3, out choice3);
        bool worked4 = int.TryParse(str4, out choice4);
        bool worked5 = float.TryParse(str5, out choice5);
        if (worked1 && worked2 && worked3 && worked4 && worked5)
            nn1.AddConnection(choice1, choice2, choice3, choice4, choice5);
        display.GetComponent<NeuralNetworkDisplay>().CreateNNDisplay();
        display.GetComponent<NeuralNetworkDisplay>().NNactivated();
    }
    public void deleteConnection()
    {
        ...
        bool worked3 = int.TryParse(str3, out choice3);
        bool worked4 = int.TryParse(str4, out choice4);
        if (worked1 && worked2 && worked3 && worked4)
            nn1.DeleteConnection(choice1, choice2, choice3, choice4);
        display.GetComponent<NeuralNetworkDisplay>().CreateNNDisplay();
        display.GetComponent<NeuralNetworkDisplay>().NNactivated();
    }
